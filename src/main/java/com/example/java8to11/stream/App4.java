...
public class App4 {
    ...
    public static void main(String[] args) {
        ...
        //TODO
        keesunEvent.stream().flatMap(Collection::stream)
                .map(OnlineClass::getTitle)
                .forEach(System.out::println);
        ...
        //TODO
        List<String> containsSpringClassNames = springClasses.stream()
                .filter(sc -> sc.getTitle().contains("spring"))
                .map(OnlineClass::getTitle)
                .collect(Collectors.toList());
        containsSpringClassNames.forEach(System.out::println);
